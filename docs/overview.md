...
**Poppins** (Bold weight) — a clean geometric sans-serif. Large (around 24pt), white, centre-aligned on each row. Nothing else competes for your eye.
...
|---|---|
| **Swipe right** on a row | Complete the task (or archive a list) |
